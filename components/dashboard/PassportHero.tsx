...
export const PassportHero: React.FC = () => {
  return (
    <section className="relative bg-[#0F111E]/88 backdrop-blur-2xl border border-white/[0.08] rounded-[18px] p-5 lg:p-6 shadow-2xl overflow-hidden border-t-2 border-t-[#F59E0B]">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <h1 className="text-3xl font-black font-orbitron text-white tracking-wide mt-1">
              NOVA_LEO<span className="text-slate-500 font-normal text-xl">#TH1</span>
            </h1>
            
            <p className="text-xs font-mono text-slate-400 mt-1 flex items-center gap-2">
              <span>TEAM: <strong className="text-slate-200">ARIES ESPORTS</strong></span>
              <span className="text-slate-600">•</span>
              <span>ROLE: <strong className="text-slate-200">DUELIST</strong></span>
            </p>
          </div>
        </div>

        {/* Right: Metrics + Dual Tokens */}
        <div className="w-full lg:w-auto flex flex-wrap items-center gap-3">
          <div className="bg-[#0F111E]/90 border border-white/[0.08] rounded-xl px-4 py-2.5 min-w-[95px]">
            <span className="text-[10px] font-orbitron font-bold text-slate-400 block tracking-wider uppercase">ACS</span>
            <span className="text-2xl font-black font-rajdhani text-[#06B6D4] leading-none">268</span>
          ...
          <div className="bg-[#0F111E]/90 border border-white/[0.08] rounded-xl px-4 py-2.5 min-w-[95px]">
            ...
            <span className="text-2xl font-black font-rajdhani text-[#F59E0B] leading-none">1.45</span>
          ...
          <div className="bg-[#0F111E]/90 border border-white/[0.08] rounded-xl px-4 py-2.5 min-w-[95px]">
            ...
            <span className="text-2xl font-black font-rajdhani text-[#10B981] leading-none">68%</span>
            <span className="text-[9px] text-slate-500 font-mono block">14W - 6L</span>
          </div>

          {/* Dual Tokens */}
          <div className="flex items-center gap-2 bg-[#15182A]/90 border border-[#F59E0B]/30 rounded-xl p-2 px-3 shadow-inner">
            <div className="flex items-center gap-2 pr-3 border-r border-white/[0.08]">
              <div className="w-7 h-7 rounded-lg bg-[#F59E0B]/10 border border-[#F59E0B]/40 flex items-center justify-center text-[#F59E0B] text-xs">
                💎
              </div>
              <div>
                <span className="text-[9px] font-orbitron font-bold text-slate-400 block">ZP POINTS</span>
                <span className="text-lg font-black font-rajdhani text-[#F59E0B] leading-tight">1,450 ZP</span>
              </div>
            </div>

            <div className="flex items-center gap-2 pl-2">
              <div className="w-7 h-7 rounded-lg bg-[#06B6D4]/10 border border-[#06B6D4]/40 flex items-center justify-center text-[#06B6D4] text-xs">
                🪙
              </div>
              <div>
                <span className="text-[9px] font-orbitron font-bold text-slate-400 block">AP TOKENS</span>
                <span className="text-lg font-black font-rajdhani text-[#06B6D4] leading-tight">850 AP</span>
              </div>
            </div>
          </div>
        </div>
